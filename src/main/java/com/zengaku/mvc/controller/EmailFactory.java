...
public class EmailFactory {
    ...
    public static void sendRecoveryMail(String receiverEmail, String newPasswordLink) {
        Properties props = new Properties();
        props.put("mail.smtp.auth", "true");
        props.put("mail.smtp.host", AutoMailCfg.HOST_NAME);
        props.put("mail.smtp.starttls.enable", "true");
        ...
        try {
            MimeMessage message = new MimeMessage(session);
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(receiverEmail));
            message.setSubject("[ZenGaku]: Reset your password");
            String body = "<html>\n" +
                    "<body>\n" +
                    "<p>" +
                    "Access this link to reset your password : " + newPasswordLink + "\n" +
                    "If you didn't request a new password, please let us know " +
                    "</p>\n" +
                    "</body>\n" +
                    "</html>";
            message.setContent(body, "text/html; charset=utf-8");
